(define (domain warehouse)
   ...
   (:action robotMove
        ...
        :effect (and (no-robot ?l0) (not (no-robot ?l1)) (not (at ?r ?l0)) (at ?r ?l1))
    )
    
    (:action robotMoveWithPallette
        :parameters (?r - robot ?p - pallette ?l0 - location ?l1 - location)
        :precondition (and (at ?r ?l0) (at ?p ?l0) (no-pallette ?l1) (no-robot ?l1) (connected ?l0 ?l1))
        :effect (and (no-pallette ?l0) (not (no-pallette ?l1)) (no-robot ?l0) (not (no-robot ?l1)) 
                    (at ?r ?l1) (at ?p ?l1) (not (at ?r ?l0)) (not (at ?p ?l0)))
    )
